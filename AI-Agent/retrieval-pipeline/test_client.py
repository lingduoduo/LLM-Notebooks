...
async def run_educational_tests():
    ...
    multilingual_docs = [
        ...
        {
            "doc_id": "ml_para_1",
            "text": "A branch of AI in which systems improve from data.",  # Same idea, reworded
            "metadata": {"language": "english", "topic": "AI"}
        },
        {
            "doc_id": "ml_es_1",
    ...
    multilingual_queries = [
        {
            ...
            "expected": ["ml_en_1", "ml_para_1", "ml_es_1"],
            "explanation": "Dense embeddings (BGE-M3) should find similar content across languages "
                           "and wordings"
        },
        {
            "query": "artificial intelligence",  # Query sharing no words with ml_para_1
            "expected": ["ml_para_1", "ml_en_1"],
            "explanation": "Dense should match the query to related documents regardless of wording"
        }
    ]
