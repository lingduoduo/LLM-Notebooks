...
module_path = os.path.join(os.path.dirname(__file__), "04_train_mini_gpt.py")
spec = importlib.util.spec_from_file_location("mini_gpt", module_path)
mini_gpt = importlib.util.module_from_spec(spec)
spec.loader.exec_module(mini_gpt)

MiniGPT = mini_gpt.MiniGPT
LayerNorm = mini_gpt.LayerNorm
FeedForward = mini_gpt.FeedForward
MultiHeadAttention = mini_gpt.MultiHeadAttention
TransformerBlock = mini_gpt.TransformerBlock
Embedding = mini_gpt.Embedding
