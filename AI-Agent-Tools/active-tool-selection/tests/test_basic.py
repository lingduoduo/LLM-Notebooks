...
def test_semantic_router():
    ...
    print("   ✓ Semantic routing working correctly")
    print("   ✓ All test queries matched appropriate servers")
    print()
...
"""
    ...
    print("   ✓ Request parsing working correctly")
    print("   ✓ Request formatting working correctly")
    print()
...
def test_routing_details():
    ...
    print("   ✓ Routing details structure correct")
...
def test_tool_schemas():
    ...
    print("   ✓ Compatible with OpenAI function calling")
    print()
