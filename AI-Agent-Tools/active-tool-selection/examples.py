...
5. Send notification email to stakeholders"""
    ...
    print("   • Token savings: ~90% compared to loading all tools")
...
5. Send deployment status notification"""
    ...
    print("   • Started with monitoring tools")
    print("   • Added deployment tools when needed")
    print("   • Included notification tools at the end")
...
def example_multi_turn_discovery():
    ...
    print(f"🤖 Agent loaded: {', '.join(result2['tools_loaded'])}")
    print()
    ...
    print(f"🤖 Agent loaded: {', '.join(result3['tools_loaded'])}")
    print()
