...
class MemoryProcessorConfig:
    ...
    # Lower temperature for analysis; defaults to MEMORY_UPDATE_TEMPERATURE in .env
    temperature: float = field(default_factory=lambda: Config.MEMORY_UPDATE_TEMPERATURE)
...
class BackgroundMemoryProcessor:
    ...
    def __init__(self,
        ...
        # Memory analysis wants a lower temperature than plain chat
        self.analysis_agent.temperature = self.config.temperature
