"""
User Memory Agent with OpenAI and React pattern
...
class UserMemoryAgent:
    ...
    def __init__(self, 
        ...
        # Sampling params from .env (MODEL_TEMPERATURE / MODEL_MAX_TOKENS).
        # Callers may override per instance; reasoning models still get
        # temperature=1 via _reasoning_safe_temperature at call time.
            ...
            try:
                ...
                if current_tool_calls:
                    ...
                    if complete_message.get("reasoning") and complete_message.get("content"):
                        logger.info("Response complete with reasoning and content")
                    else:
