...
async def main():
    ...
    documents = [
        ...
        # Category 4: Multilingual / reworded content
        {
            "doc_id": "ml_reworded",
            "text": "Training models on data is the core technique behind AI for solving problems.",
    ...
    test_queries = [
        ...
        },
        {
            ...
            "description": "Cross-lingual and reworded search - Dense should excel",
            "expected_strong": "dense",
            "explanation": "Dense embeddings (BGE-M3) handle multiple languages and wordings"
        },
        {
            "query": "Yann LeCun",
