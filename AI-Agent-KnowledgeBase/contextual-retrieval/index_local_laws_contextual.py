...
class ContextualLegalIndexer:
    ...
    def generate_document_id(self, doc_info: Dict[str, Any]) -> str:
        ...
        - "labor_law(2018-12-29).md" -> "labor_law_2018-12-29"
          (CJK full-width parentheses are handled the same way)
        - "civil_code/book_one_general.md" -> "civil_code_book_one_general"
        """
        ...
        # \uff08 \uff09 are the CJK full-width parentheses used in law filenames
        # such as "\u52b3\u52a8\u6cd5\uff082018-12-29\uff09.md"
    ...
    def compare_retrieval_methods(self, test_queries: Optional[List[str]] = None):
        ...
        if not test_queries:
            test_queries = [
                "What are the conditions for a contract to be formed",
